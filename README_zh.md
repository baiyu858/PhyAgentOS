...
> **说明**: PhyAgentOS 采用插件化设计，任何支持 Python 控制接口的硬件均可通过 `hal/drivers/` 快速接入。社区插件开发参考模板见 `docs/PLUGIN_DEVELOPMENT_GUIDE_zh.md`，对应英文版见 `docs/PLUGIN_DEVELOPMENT_GUIDE.md`。
